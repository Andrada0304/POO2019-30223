...
//import SortarePersoane.Persoana;
...
/*	System.out.println("\n");
	...
	*/
		...
		animals.add(animalList[0]);
		animals.add(animalList[1]);
		animals.add(animalList[2]);
		animals.add(animalList[3]);
		animals.add(animalList[4]);
		
		ArrayList<Employee> employees=new ArrayList<Employee>();
		employees.add(employeeList[0]);
		employees.add(employeeList[1]);
		employees.add(employeeList[2]);
		employees.add(employeeList[3]);
